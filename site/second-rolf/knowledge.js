...
const portfolio = [
  ...
  { id: 'ai', url: './', terms: ['ai','ki','kunstig','intelligens','modell','mistral','ministral','local'], answer: 'AI brukes først og fremst som et verktøy rundt konkrete arbeidsproblemer: kildebaserte svar, metadataforslag og interaktive assistenter. Second Rolf lager live-svar med Ministral 3 14B på Rolfs egen GPU, uten betalt sky-AI som fallback.', source: 'Offentlig portefølje · Second Rolf-arkitektur' },
...
export const knowledge = [...portfolio, ...interview.entries.map(entry => ({
  ...
  answer: entry.summary, source: `Rolf · intervju 14.09.2026 · ${entry.topic}`,
  kind: entry.kind, date: interview.date, limits: entry.limits
}))];
...
// Whole terms/phrases prevent short terms such as AI from matching unrelated words.
