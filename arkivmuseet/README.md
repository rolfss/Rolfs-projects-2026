...
- **På veggene:** 14 innrammede verk i fem gallerier: stedsfotografier, autentiske rapportsider, korte kildeutdrag og to nyhetspaneler fra forskning.no og VG/NTB. Fire bilder finnes også i hovedhallen. Alle verk kan åpnes fra «Veggbilder», uten å sikte med kameraet.
- Fem veggfarger, fargede bannere, leselys og gulvmarkeringer gir rommene egen karakter. «Neste verk» flytter mellom rolige, innpassede utsnitt; besøkeren bestemmer tempoet. Fotografier beholder proporsjonene sine.
- Fotografier fra Osen, Tokke og Hanekleivtunnelen, samt rapportsider fra Osen, Tokke og NPE, er inkludert lokalt. Stedsbilder er merket med dato. Pressepanelene er kuraterte overskriftsutdrag i museets utforming. Se `public/assets/cases/credits.json` og `cases/gallery.json`.
...
- Lyden er valgfri og starter bare etter et klikk. Papirlyder, serversus, stille romtone, tunnelklang og klokketakt skiller rommene. De tenkte ledervalgene endrer lys og demper eller gjenoppretter romlyden. Tekst beskriver lyden; ingenting formidles bare gjennom lyd. Ingen historiske lydopptak brukes.
